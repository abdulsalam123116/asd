...
class PosController extends Controller
{
    public function index()
    {
        ...
        return [
            ...
            'storeAddress' => $storeTaxes[0]->address,
        ];
    }
    ...
    public function saveReceipt(Request $request)
    {
        ...
        // Define a variable to store the generated receipt number
        $generatedReceiptNo = '';
        try {
            ...
            if ($itemLists != NULL) {
                ...
                // Save the generated receipt number to the variable
                $generatedReceiptNo = $receiptNo;
                ...
                $response = response()->json([
                    ...
                    'receipt_no' => $generatedReceiptNo // Return the generated receipt number
                ]);
            } else {
                $response = response()->json([
                    'alert' => 'danger',
