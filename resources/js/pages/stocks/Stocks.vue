<template>
    ...
    >
        ...
        <p class="warning-content p-mb-3">
            ...
            WARNING: By Changing any numeric value listed in this screen will
            cause serious effects on accounting records of inventory.
        </p>
        <div class="p-grid">
            <div class="p-col">
                <div class="p-field">
                    <label
                        for="productName"
                        :class="{
                            'p-error': v$.productName.$invalid && submitted,
                        }"
                        >Product Name</label
                    >
                    <InputText
                        ...
                        :class="{
                            'p-invalid': v$.productName.$invalid && submitted,
                        }"
                ...
                <div class="p-field">
                    <label
                        for="generic"
                        :class="{ 'p-error': v$.generic.$invalid && submitted }"
                        >Generic Name</label
                    >
                    <InputText
                        id="generic"
                        ...
                        :class="{
                            'p-invalid': v$.generic.$invalid && submitted,
                        }"
                    ...
                    <small
                        ...
                        class="p-error"
                        >{{
                            v$.generic.required.$message.replace(
                                "Value",
                                "Generic Name"
                            )
                        }}</small
            ...
            <div class="p-col">
                ...
                <div class="p-field">
                    <label
                        for="packSize"
                        :class="{
                            'p-error': v$.packSize.$invalid && submitted,
                        }"
                        >Pack Size</label
                    >
                    <InputNumber
                        ...
                        :useGrouping="false"
                        :class="{
                            'p-invalid': v$.packSize.$invalid && submitted,
                        }"
                    />
                    <small
                        v-if="
                        ...
                        class="p-error"
                        >{{
                            v$.packSize.required.$message.replace(
                                "Value",
                                "Pack Size"
                            )
                        }}</small
                ...
                <div class="p-field">
                    <label
                        for="stripSize"
                        :class="{
                            'p-error': v$.stripSize.$invalid && submitted,
                        }"
                        >Strip Size</label
                    >
                    <InputNumber
                        ...
                        :class="{
                            'p-invalid': v$.stripSize.$invalid && submitted,
                        }"
                        :useGrouping="false"
                    />
                    <small
                        ...
                        class="p-error"
                        >{{
                            v$.stripSize.required.$message.replace(
                                "Value",
                                "Strip Size"
                            )
                        }}</small
                ...
                <div class="p-field">
                    ...
                    <InputText
                        ...
                        :class="{
                            'p-invalid': v$.batchNo.$invalid && submitted,
                        }"
                    />
                    <small
                        v-if="
                        ...
                        class="p-error"
                        >{{
                            v$.batchNo.required.$message.replace(
                                "Value",
                                "Batch No"
                            )
                        }}</small
            ...
            <div class="p-col">
                <div class="p-field">
                    ...
                    <InputNumber
                        ...
                        :class="{
                            'p-invalid': v$.unitQty.$invalid && submitted,
                        }"
                        :useGrouping="false"
                    />
                    <small
                        ...
                        class="p-error"
                        >{{
                            v$.unitQty.required.$message.replace(
                                "Value",
                                "Unit Qty"
                            )
                        }}</small
                ...
                <div class="p-field">
                    <label
                        for="packPurchase"
                        :class="{
                            'p-error': v$.packPurchase.$invalid && submitted,
                        }"
                        >Pack Purchase</label
                    >
                    <InputNumber
                    ...
                    <small
                        ...
                        class="p-error"
                        >{{
                            v$.packPurchase.required.$message.replace(
                                "Value",
                                "Pack Purchase"
                            )
                        }}</small
                ...
                <div class="p-field">
                    <label for="packSelling">Pack Selling</label>
                    <InputNumber
                        id="packSelling"
                ...
                <div class="p-field">
                    <label
                        for="storeLocation"
                        :class="{
                            'p-error': v$.storeLocation.$invalid && submitted,
                        }"
                    ...
                    <InputText
                        ...
                        :class="{
                            'p-invalid': v$.storeLocation.$invalid && submitted,
                        }"
                    />
                    <small
                        v-if="
                        ...
                        class="p-error"
                        >{{
                            v$.storeLocation.required.$message.replace(
                                "Value",
                                "Store Location"
                            )
                        }}</small
            ...
            <div class="p-col">
                <div class="p-field" v-if="taxNames[0].show == 'true'">
                    <label for="tax_1">{{ taxNames[0].taxName }}</label>
                    <InputNumber
                        id="tax_1"
                        v-model="item.tax_1"
                        :useGrouping="false"
                ...
                <div class="p-field" v-if="taxNames[1].show == 'true'">
                    <label for="tax_2">{{ taxNames[1].taxName }}</label>
                    <InputNumber
                        id="tax_2"
                        v-model="item.tax_2"
                        :useGrouping="false"
                ...
                <div class="p-field" v-if="taxNames[2].show == 'true'">
                    <label for="tax_3">{{ taxNames[2].taxName }}</label>
                    <InputNumber
                        id="tax_3"
                        v-model="item.tax_3"
                        :useGrouping="false"
                ...
                <div class="p-field">
                    <label
                        for="expiryDate"
                        :class="{
                            'p-error': v$.expiryDate.$invalid && submitted,
                        }"
                        >Expiry Date</label
                    >
                    <Calendar
                    ...
                    <small
                        ...
                        class="p-error"
                        >{{
                            v$.expiryDate.required.$message.replace(
                                "Value",
                                "Expiry Date"
                            )
                        }}</small
                ...
                <div class="p-field">
                    <label
                        for="minStock"
                        :class="{
                            'p-error': v$.minStock.$invalid && submitted,
                        }"
                    ...
                    <InputText
                        ...
                        :class="{
                            'p-invalid': v$.minStock.$invalid && submitted,
                        }"
                    />
                    <small
                        v-if="
                        ...
                        class="p-error"
                        >{{
                            v$.minStock.required.$message.replace(
                                "Value",
                                "Store Location"
                            )
                        }}</small
        ...
        this.stockService.getItem(data).then((res) => {
            ...
            if (res != null) {
                ...
                this.item.sideEffects =
                    res.side_effects == null ? "" : res.side_effects;
