                ...
                <div class="p-grid p-m-0">
                    <div class="p-col-9">
                        ...
                        <div class="pos-table" style="height: 72.7vh">
                            <table
                                class="table table-stiped table-bordered p-m-0"
                            >
                                <thead>
                                ...
                                <tbody>
                                    <template
                                        v-for="savedItem in savedItemList
                                            .slice()
                                            .reverse()"
                                        :key="savedItem"
                                    >
                    ...
                    <div class="p-col-3" style="border-left: 1px solid #eee">
                        <div class="p-fluid">
                            <div class="p-field">
                                ...
                                <span
                                    v-if="
                                        v$.selectedProfile.$error && submitted
                                    "
                                >
                                    <span
                                        id="p-error"
                                        v-for="(error, index) of v$
                                            .selectedProfile.$errors"
                                        :key="index"
                                    >
                                        <small class="p-error">{{
                                            error.$message
                        ...
                        <div class="p-fluid" v-if="item.type == 'TRN'">
                            <div class="p-field">
                                ...
                                <span
                                    v-if="
                                        v$.transferStoreID.$error && submitted
                                    "
                                >
                                    <span
                                        id="p-error"
                                        v-for="(error, index) of v$
                                            .transferStoreID.$errors"
                                        :key="index"
                                    >
                                        <small class="p-error">{{
                                            error.$message
                        ...
                        <div class="p-fluid" v-if="item.type != 'TRN'">
                            <div class="p-field">
                                ...
                                <InputText
                                    ...
                                    placeholder="e.g Patient Jhon Doe"
                                />
                            </div>
                        </div>
                        <div class="p-fluid" v-if="item.type != 'TRN'">
...
export default class PosReceipt extends Vue {
    ...
    private unitType = ["Pack", "Strip", "Unit"];
    ...
    getTheSubtotal(data) {
        ...
        if (data.stockQty < totalUnits && this.item.type != "RFD") {
            ...
            this.toast.showError(
                "Item does not have enough stock qty for pack"
            );
        }
    ...
    get totalGross() {
        ...
        this.savedItemList.forEach((e) => {
            total = total + e.sellingPrice * e.unit;
        });
    ...
    fetchReceiptNo() {
        this.posService
            .getReceiptItems(this.item.searchReceiptNo)
            .then((data) => {
